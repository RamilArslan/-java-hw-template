...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    Woman motherBlack = new Woman("June", "Black", 1976);
    motherBlack.setIq(65);
    Man fatherBlack = new Man("Alex", "Black", 1970);
    fatherBlack.setIq(75);
    Family familyBlack = new Family(fatherBlack, motherBlack);


    Man fatherAliyev = new Man("Ali", "Aliyev", 1981);
    fatherAliyev.setIq(75);
    Woman motherAliyev = new Woman("Nur", "Aliyev", 1983);
    motherAliyev.setIq(65);
    Family familyAliyev = new Family(fatherAliyev, motherAliyev);


    Man fatherWhite = new Man("Piter", "White", 1980);
    fatherWhite.setIq(75);
    Woman motherWhite = new Woman("Yana", "White", 1985);
